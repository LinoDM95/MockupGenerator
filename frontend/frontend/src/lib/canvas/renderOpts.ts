...
export const getTemplateRenderOpts = (tpl: Template): TemplateRenderOpts => ({
  ...
  foldStrength: tpl.foldStrength ?? 0.35,
  foldShadowDepth: tpl.foldShadowDepth ?? 0.28,
  foldHighlightStrength: tpl.foldHighlightStrength ?? 0.08,
  foldSmoothing: tpl.foldSmoothing ?? 6,
  sobelRadius: tpl.sobelRadius,
  analysisDenoise: tpl.analysisDenoise,
  foldNoiseFloor: tpl.foldNoiseFloor,
});
