  ...
  return (
    <LegalPageLayout title="Datenschutzerklärung">
      ...
      <p>
        ...
        (z. B. IP-Adresse, Zeitstempel, User-Agent) in Server-Logs verarbeitet werden. Rechtsgrundlage:
      ...
      <p>
        ...
        die Verarbeitung beim jeweiligen Anbieter gemäß dessen AV-Vertrag bzw. Standardvertragsklauseln.
        Rechtsgrundlage: Art. 6 Abs. 1 lit. b bzw. f DSGVO.
      </p>

      <h2>6. Drittanbieter-Integrationen (optional)</h2>
      <p>Wenn du optionale Integrationen aktivierst, können Daten an die jeweiligen Plattformen übermittelt werden, z. B.:</p>
      <ul>
        <li>
          <strong>Etsy</strong> — OAuth und API-Aufrufe zur Shop-/Listing-Verwaltung (Verarbeitung gemäß Etsy-Richtlinien).
        </li>
        <li>
          <strong>Pinterest</strong> — OAuth und API-Aufrufe (Verarbeitung gemäß Pinterest-Richtlinien).
        </li>
      </ul>
      ...
      <p>
        ...
        ist oder gesetzliche Aufbewahrungsfristen bestehen. Kontodaten löschen wir nach Kündigung /
        Löschwunsch, soweit keine Pflicht zur Aufbewahrung entgegensteht.
      </p>
