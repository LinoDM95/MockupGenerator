...
export const GlobalLegalFooter = () => {
  ...
  return (
    <footer
      className="w-full shrink-0 bg-white/90 shadow-[0_-2px_12px_rgba(0,0,0,0.04)] ring-1 ring-slate-900/5 backdrop-blur-xl dark:bg-slate-100/92 dark:shadow-[0_-2px_20px_rgba(0,0,0,0.45)] dark:ring-white/10"
      role="contentinfo"
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-5 px-4 py-6 pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] sm:px-6 sm:py-8">
        <div className="flex flex-col items-center gap-2 text-center">
          <span className="flex items-center gap-2 text-sm font-bold tracking-tight text-slate-900 sm:text-base">
            <span
